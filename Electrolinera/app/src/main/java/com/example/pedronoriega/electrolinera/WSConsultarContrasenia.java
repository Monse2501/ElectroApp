...
public class WSConsultarContrasenia { //clase para conexion con el servicio php iniciarSesion.php
    ...
    public WSConsultarContrasenia(Context context)
    {
    ...
    public void iniciarSesionInBackground(Usuario usuario, GetUserCallback userCallback){
        ...
        //progressDialog.show();
        new cambiarContraseniaAsyncTask(usuario, userCallback).execute();

    }

    public class cambiarContraseniaAsyncTask extends AsyncTask<Void, Void, Usuario>
    {
        Usuario usuario;
        GetUserCallback userCallback;

        public cambiarContraseniaAsyncTask(Usuario usuario, GetUserCallback callback){
        ...
        protected Usuario doInBackground(Void... params) {
            ...
            HttpPost post = new HttpPost(SERVER_ADDRESS + "consultarContrasena.php");
            ...
            try{
                ...
                if(jObject.length()== 0){
                    ...
                    String resultado = jObject.getString("resultado");
